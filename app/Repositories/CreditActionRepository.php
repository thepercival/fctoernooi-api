 ...
 */
final class CreditActionRepository extends EntityRepository
{
    public const int CREATE_ACCOUNT_CREDITS = 3;
    public const int VALIDATE_ACCOUNT_CREDITS = 3;
    public const int NR_OF_CREDITS_PER_TOURNAMENT = 1;
